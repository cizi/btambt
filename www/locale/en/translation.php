...
define("USER_EDIT_WEB_LABEL_DET", '(complete URL begins with http)');
...
define("DOG_TABLE_DOG_ADD_SIBLING", 'Add sibling');
...
define("DOG_FORM_HEALTH_COM", 'Admin comment');
...
define("DOG_FORM_HIDE_DOG_LEAD", 'Hide lead');
...
define("COVERAGE_EXPRESS", "Coverage sheet - payment confirmation add to the attachment");
define("COVERAGE_EXPRESS_NO_FILE", "Please, attache the payment.");
...
define("COVERAGE_MAIL_SENT", "Already sent to user");
...
define("COVERAGE_CONFIRM", "Really send covarege list?");
...
define("AWAITING_CHANGE_PROCEEDED_INS", "In progress");
define("AWAITING_CHANGE_PROCEEDED_OK_SUBJECT", "Your change request has been apporved");
define("AWAITING_CHANGE_PROCEEDED_OK_BODY", "Hello, <br />your change request has been approved. Please, take a look here <a href='%s'>%s</a>.");
...
define("AWAITING_CHANGE_NEW_DOG_NEED_APPROVAL_BODY_ADMIN", "Hello, <br />a new dog card has been created <a href='%s'>%s</a>. Please, log in for approval or decline the request.");
