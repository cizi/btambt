...
define("USER_EDIT_WEB_LABEL_DET", '(celá URL začínající http)');
...
define("DOG_TABLE_DOG_ADD_SIBLING", 'Založit sourozence');
...
define("DOG_FORM_HEALTH_COM", 'Poznámka administrátora');
...
define("DOG_FORM_HIDE_DOG_LEAD", 'Skrýt svod');
...
define("MATING_FORM_INFO_BREEDER", "");
...
define("COVERAGE_EXPRESS", "Krycí list - potvrzení o zaplacení poplatku nahrát do přílohy");
define("COVERAGE_EXPRESS_NO_FILE", "Prosím, nahrajte platbu.");
...
define("COVERAGE_MAIL_SUBJECT_UPDATE", "Aktualizace krycího list");
...
define("AWAITING_CHANGE_PROCEEDED_INS", "Nezpracováno");
define("AWAITING_CHANGE_PROCEEDED_OK_SUBJECT", "Váš požadavek na změnu byl schválen");
define("AWAITING_CHANGE_PROCEEDED_OK_BODY", "Dobrý den, <br />Váš požadavek na změnu byl schválen. Prosím, proveďte kontrolu zde <a href='%s'>%s</a>.");
...
define("AWAITING_CHANGE_NEW_DOG_NEED_APPROVAL_BODY_ADMIN", "Dobrý den, <br />byla založena nová karta psa <a href='%s'>%s</a>. Pro schválení nebo zamítnutí se, prosím, přihlaste do administrace.");
